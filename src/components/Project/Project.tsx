      ...
      <div className="projects">
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>طراحی سایت ایزونتورک</h3>
              <p> این پروژه از فناوری روز استفاده میکنه نصب و اجرای ری اکت به همراه کد منبع باز برای دوستاران توسعه در گیت هاب موجود هست و دارای گواهینامه اس اس الو امنیت داده ها در برابر حملات </p>
            </div>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              ...
              <p>
              یک برنامه وب مبتنی بر هوش مصنوعی برای لیست‌های انجام کار! این یک برنامه Angular است که با استفاده از Gemini API و Firebase ساخته شده است
              Gemini API به شما امکان دسترسی به جدیدترین مدل‌های هوش مصنوعی مولد Google را می‌دهد - خانواده مدل‌های چند وجهی Gemini. این برنامه‌ریزی با برنامه وب Gemini API، Gemini API را فراخوانی می‌کند تا یک لیست کار از متن یا تصویر ارائه شده توسط کاربر نهایی ایجاد کند
              </p>
            </div>
            <footer>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              ...
              <p>
              Bagisto یک چارچوب تجارت الکترونیک لاراول منبع باز است که بر روی برخی از داغ ترین فناوری ها مانند Laravel (فریم ورک PHP) و Vue.js یک چارچوب جاوا اسکریپت مترقی ساخته شده است
              </p>
            </div>
            <footer>
              <ul className="tech-list">
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              ...
              <p>این یک قالب وب سایت رزومه شخصی مبتنی بر React است. ساخته شده با تایپ اسکریپت در چارچوب Next.js، استایل بندی شده با Tailwind css، و پر از داده های یک فایل واحد، می توانید به راحتی وب سایت شخصی خود را در عرض چند دقیقه ایجاد، سفارشی سازی و میزبانی کنید. حتی بهتر از آن، سایت کاملاً برای موبایل بهینه شده و در سمت سرور ارائه شده است تا از بارگیری سریع و یک رابط کاربری تمیز در هر دستگاهی اطمینان حاصل شود. در ادامه بخوانید تا یاد بگیرید چگونه آن را خودتان بسازید</p>
            </div>
            <footer>
              <ul className="tech-list">
                <li>PHP</li>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              ...
              <p>این یک برنامه ساده Todo است که از جنگو (شامل چارچوب Django REST برای عملیات API CRUD) و React ساخته شده است. برای توضیح کامل، به ساخت اپلیکیشن To-Do با استفاده از Django و React مراجعه کنید</p>
            </div>
            <footer>
              <ul className="tech-list">
                <li>OpenCV</li>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              ...
              <p>
                یک پروژه ساده که در آن برای کسانی که تازه وارد هستند آزمایشی هستش که بتوانند با گیت هاب کار کنن اینطوری هستش که باید یک کد رو وسط چند تا کد دیگه بیاری یه پروژه ساده و چالش آور از جادی Hassan khodabakhshi 💎 💎 💎 💎 💎
              </p>
            </div>
            <footer>
              <ul className="tech-list">
